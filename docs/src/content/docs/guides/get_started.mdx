...
- **Terminal:** [Ghostty](https://ghostty.org/),
  ...
  are all great terminals that support most <Pls /> features.
...
You can use `--tag` to install a specific version. Version
<Version owner="pls-rs" repo="pls" /> is the latest available version. Or you
can use `--branch main` to get the latest, unreleased version.
...
1. Download the binary file. You can either download the binary associated with
   ...
   - **Release**
     ...
     2. Find the [latest release](https://github.com/pls-rs/pls/releases/latest)
        i.e. v<Version owner="pls-rs" repo="pls" />.
...
<pre className="terminal">
  pls <Version owner="pls-rs" repo="pls" />
</pre>
